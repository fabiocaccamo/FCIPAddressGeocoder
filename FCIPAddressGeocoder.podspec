Pod::Spec.new do |spec|
  ...
  spec.summary      = 'iOS Geocoder for geocode device IP Address location using FreeGeoIP service and a block-based syntax.'
  spec.source       = { :git => 'https://github.com/fabiocaccamo/FCIPAddressGeocoder.git', :tag => '1.0.2' }
